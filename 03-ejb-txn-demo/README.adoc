...
s2i build -e GALLEON_PROVISION_DEFAULT_FAT_SERVER=true client/ demo-parent demo-client-build
s2i build -e GALLEON_PROVISION_DEFAULT_FAT_SERVER=true server/ demo-parent demo-server-build
----
