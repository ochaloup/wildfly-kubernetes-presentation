...
public class RemoteBeanCaller {
     ...
     * see {@link RemoteLookupHelper#lookupRemoteEJBDirect(String, Class, boolean, String, int, String, String)}.
     * </p>
     * <p>
     ...
     * @throws RemoteException when bean call fails
     */
    public List<String> directLookupStatelessBeanCall() throws NamingException, RemoteException {
