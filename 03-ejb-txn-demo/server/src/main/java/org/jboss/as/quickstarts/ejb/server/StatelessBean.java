...
public class StatelessBean implements RemoteBeanInterface {
     ...
     * @throws RemoteException an error on remote execution occurs
     */
    @Override
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public String successOnCall() throws RemoteException {
    ...
    /**
     * Failure during commit does not mean {@link RemoteException} for this business method
     * as uncommitted {@link javax.transaction.xa.XAResource}s will be committed later by periodic recovery.
     */
    @Override
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public String failOnCall() throws RemoteException {
